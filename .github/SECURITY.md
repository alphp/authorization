...
[version map](https://github.com/cakephp/authorization/wiki#version-map).
Versions marked as EOL no longer receive fixes.

## Reporting a Vulnerability

If you've found a security issue in the CakePHP Authorization plugin, please use the following procedure
